...
Javascript, TypeScript, ReactJS, C#, .NET Core, Automation Testing, Technical Architecture, Design Patterns, System Design, Microservices, 
CSS/SCSS, User Experience/UI/UX, Product Management, Agile & Project Management
